  ...
  return (
    <ConfiguratorRoot variant="permanent" ownerState={{ openConfigurator }}>
      ...
      <MDBox pt={0.5} pb={3} px={3}>
        <MDBox>
          <MDTypography variant="h6">Couleur des navigations</MDTypography>
        ...
        <MDBox mt={3} lineHeight={1}>
          <MDTypography variant="h6">Type de navigation</MDTypography>
        ...
        <MDBox
          ...
          lineHeight={1}
        >
          <MDTypography variant="h6">Fixer le navbar</MDTypography>

          <Switch checked={fixedNavbar} onChange={handleFixedNavbar} />
        </MDBox>
        <Divider />
        <MDBox display="flex" justifyContent="space-between" alignItems="center" lineHeight={1}>
          <MDTypography variant="h6">Mode</MDTypography>
